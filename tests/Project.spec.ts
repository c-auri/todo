...
describe('Project.fromJSON', () => {
    ...
    test('deserializes tasks correctly', () => {
        const originalTask1 = new Task('ID', 'TestTask1', "TestDescription1", new Date(), true)
        const originalTask2 = new Task('ID', 'TestTask1', "TestDescription1", new Date(), true)
    ...
    test('deserializes project correctly', () => {
        const originalTasks = [ new Task('ID', 'TestTask', "TestDescription1", new Date(), true) ]
