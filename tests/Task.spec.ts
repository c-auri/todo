...
describe('Task.fromJSON', () => {
    test('deserializes id correctly', () => {
        const originalTask = new Task('TestTask', 'TestDescription', new Date(), "12:00", 'ID')
    ...
    test('deserializes title correctly', () => {
        ...
        const originalTask = new Task(originalTitle, 'TestDescription', new Date(), "12:00", 'ID')
        const deserializedTask = Task.fromJSON(JSON.stringify(originalTask))
    ...
    test('deserializes description correctly', () => {
        ...
        const originalTask = new Task("TestTitle", originalDescription, new Date(), "12:00", 'ID')
        const deserializedTask = Task.fromJSON(JSON.stringify(originalTask))
    ...
    test('deserializes date correctly', () => {
        ...
        const originalTask = new Task('TestTask', 'TestDescription', originalDate, originalTime, 'ID')
        const deserializedTask = Task.fromJSON(JSON.stringify(originalTask))
        expect(deserializedTask.date).toEqual(expectedDate)
    })
    test('deserializes time correctly', () => {
        const originalTime = "12:00"
        const originalTask = new Task('TestTask', 'TestDescription', new Date(), originalTime, 'ID')
        const deserializedTask = Task.fromJSON(JSON.stringify(originalTask))
